...
// });
(function() { this.JST || (this.JST = {}); this.JST["checkouts/address_form"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<section id="add-address-form-overlay">\n  <div id="add-address-relative-container">\n    <div id="add-address-modal">\n      <div class="top-bar group">\n        <span class="top-bar-title">\n          Add a shipping address\n        </span>\n        <span class="top-bar-x">\n          &times\n        </span>\n      </div>\n      <div id="add-address-form-container">\n        <form id="add-address-form" action="checkout/add_address" method="post">\n          <div class="form-row">\n            <div class="first-form-cell">\n              <span>Full Name</span>\n            </div>\n            <div class="second-form-cell">\n              <input id="address-name"\n                     type="text"\n                     size="40"\n                     name="address[name]"\n                     autofocus="autofocus"/>\n            </div>\n          </div>\n\n          <div class="form-row">\n            <div class="first-form-cell">\n              <span>Street</span>\n            </div>\n            <div class="second-form-cell">\n              <input type="text" size="40" name="address[street]"/>\n            </div>\n          </div>\n\n          <div class="form-row">\n            <div class="first-form-cell">\n              <span>Apt</span>\n            </div>\n            <div class="second-form-cell">\n              <input type="text" size="4" name="address[apt]"/>\n            </div>\n          </div>\n\n          <div class="form-row">\n            <div class="first-form-cell">\n              <span>City</span>\n            </div>\n            <div class="second-form-cell">\n              <input type="text" size="30" name="address[city]"/>\n            </div>\n          </div>\n\n          <div class="form-row">\n            <div class="first-form-cell">\n              <span>State</span>\n            </div>\n            <div class="second-form-cell">\n              <select name="address[state]">\n                <option value="AL">AL</option>\n                <option value="AK">AK</option>\n                <option value="AZ">AZ</option>\n                <option value="AR">AR</option>\n                <option value="CA">CA</option>\n                <option value="CO">CO</option>\n                <option value="CT">CT</option>\n                <option value="DE">DE</option>\n                <option value="DC">DC</option>\n                <option value="FL">FL</option>\n                <option value="GA">GA</option>\n                <option value="HI">HI</option>\n                <option value="ID">ID</option>\n                <option value="IL">IL</option>\n                <option value="IN">IN</option>\n                <option value="IA">IA</option>\n                <option value="KS">KS</option>\n                <option value="KY">KY</option>\n                <option value="LA">LA</option>\n                <option value="ME">ME</option>\n                <option value="MD">MD</option>\n                <option value="MA">MA</option>\n                <option value="MI">MI</option>\n                <option value="MN">MN</option>\n                <option value="MS">MS</option>\n                <option value="MO">MO</option>\n                <option value="MT">MT</option>\n                <option value="NE">NE</option>\n                <option value="NV">NV</option>\n                <option value="NH">NH</option>\n                <option value="NJ">NJ</option>\n                <option value="NM">NM</option>\n                <option value="NY">NY</option>\n                <option value="NC">NC</option>\n                <option value="ND">ND</option>\n                <option value="OH">OH</option>\n                <option value="OK">OK</option>\n                <option value="OR">OR</option>\n                <option value="PA">PA</option>\n                <option value="RI">RI</option>\n                <option value="SC">SC</option>\n                <option value="SD">SD</option>\n                <option value="TN">TN</option>\n                <option value="TX">TX</option>\n                <option value="UT">UT</option>\n                <option value="VT">VT</option>\n                <option value="VA">VA</option>\n                <option value="WA">WA</option>\n                <option value="WV">WV</option>\n                <option value="WI">WI</option>\n                <option value="WY">WY</option>\n              </select>\n            </div>\n          </div>\n\n          <div class="form-row">\n            <div class="first-form-cell">\n              <span>ZIP Code</span>\n            </div>\n            <div class="second-form-cell">\n              <input type="text" size="10" name="address[zip]"/>\n            </div>\n          </div>\n\n          <div class="form-row">\n            <span class="first-form-cell"></span>\n            <div class="second-form-cell">\n              <input type="checkbox" name="set_as_default" value="true">\n              Use as my default shipping address\n            </div>\n          </div>\n\n          <div id="add-address-form-button-container">\n            <button>Add your shipping address</button>\n          </div>\n        </form>\n      </div>\n    </div>\n  </div>\n</section>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["checkouts/cart_items"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('');  products.each( function(product){ ; __p.push('\n  ');  var cartProduct = cartProducts.getOrFetchByCartAndProductId(cart.id, product.id); ; __p.push('\n  <ul class="checkout-product">\n    <li class="checkout-product-image-cell">\n      <ul>\n        <li>\n          <img src="',  product.escape("small_picture_url") ,'"\n               alt="product img" />\n        </li>\n      </ul>\n    </li>\n\n    <li class="checkout-product-info-cell">\n      <ul>\n        <li class="checkout-product-name">\n          ',  product.escape("name") ,'\n        </li>\n\n        ');  var quantity = product.escape("quantity") ; __p.push('\n        ');  if (quantity < 1) { ; __p.push('\n            <li class="out-of-stock">\n              Out of Stock\n            </li>\n        ');  } else if (quantity > 25) { ; __p.push('\n            <li class="in-stock">\n              In Stock\n            </li>\n        ');  } else { ; __p.push('\n            <li class="left-in-stock">\n              Only ',  quantity ,' left in stock.\n            </li>\n        ');  }; ; __p.push('\n\n        ');  if(cartProduct) { ; __p.push('\n          <form class="checkout-product-update-quantity"\n                action="/api/cart_products/qty/',  product.id ,'"\n                method="post">\n            <input type="hidden" name="_method" value="patch">\n            <input type="hidden" name="checkout?" value="true">\n            <input class="checkout-product-quantity-input"\n                   type="number"\n                   min="0"\n                   max="',  product.escape("quantity") ,'"\n                   name="cart_product[quantity]"\n                   value="',  cartProduct.escape("quantity") ,'">\n            <br>\n            <button class="checkout-product-quantity-update">\n              Update\n            </button>\n          </form>\n        ');  }; ; __p.push('\n\n        <li class="checkout-product-seller">\n          Sold by ',  product.escape("seller_name") ,'\n        </li>\n      </ul>\n    </li>\n  </ul>\n');  }) ; __p.push('\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["checkouts/checkout"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<main id="checkout-view">\n  <section id="checkout-body">\n    <ul id="shipping-address" class="checkout-steps">\n      <li id="shipping-address-step-number" class="step-number">\n        1\n      </li>\n      <li class="step-title-span">\n        <span id="shipping-address-title" class="step-title">\n          Shipping Address\n        </span>\n      </li>\n      <li class="step-current-selection-span">\n        <span id="shipping-address-current-selection">\n          <span id="loading-address-current-selection">\n            Loading...\n          </span>\'\n        </span>\n      </li>\n      <li class="step-button-span">\n        <span id="shipping-address-button" class="step-button">\n          Change Address\n        </span>\n      </li>\n    </ul>\n\n    <div id="shipping-address-options">\n      <span id="loading-address-options">\n        Loading...\n      </span>\n    </div>\n\n    <ul id="payment-method" class="checkout-steps">\n      <li id="payment-method-step-number" class="step-number">\n        2\n      </li>\n      <li class="step-title-span">\n        <span id="payment-method-title" class="step-title">\n          Payment Method\n        </span>\n      </li>\n      <li class="step-current-selection-span">\n        <span id="payment-method-current-selection">\n          <span id="loading-payment-current-selection">\n            Loading...\n          </span>\n        </span>\n      </li>\n      <li class="step-button-span">\n        <span id="payment-method-button" class="step-button">\n          Change Card\n        </span>\n      </li>\n    </ul>\n\n    <div id="payment-method-options">\n      <span id="loading-payment-options">\n        Loading...\n      </span>\n    </div>\n\n    <ul id="review-cart" class="checkout-steps">\n      <li class="step-number">\n        3\n      </li>\n      <li class="step-title-span">\n        <span id="review-cart-title" class="step-title">\n          Cart Items\n        </span>\n      </li>\n      <li class="step-button-span">\n        <span id="review-cart-button" class="step-button">\n          View\n        </span>\n      </li>\n    </ul>\n\n    <div id="checkout-products">\n      <span id="loading-checkout-products">\n        Loading...\n      </span>\n    </div>\n  </section>\n\n  <section id="checkout-sidebar">\n    <div id="checkout-sidebar-box">\n      <form action="/checkout/add_purchased_products" method="post">\n        <input type="hidden" name="amount" value="">\n        <button id="checkout-place-order">\n          Place your order\n        </button>\n      </form>\n\n      <section class="checkout-sidebar-pricings">\n        <div id="checkout-order-summary">\n          Order Summary\n        </div>\n        <div id="checkout-price-details">\n          <ul class="checkout-details-table">\n            <li class="checkout-details-row">\n              <div class="checkout-details-cell-one">\n                Items(<span id="checkout-sidebar-items-quantity">0</span>):\n              </div>\n              <div class="checkout-details-cell-two">\n                $<span id="checkout-sidebar-items-price">0.00</span>\n              </div>\n            </li>\n            <li class="checkout-details-row">\n              <div class="checkout-details-cell-one">\n                Shipping & handling:\n              </div>\n              <div class="checkout-details-cell-two">\n                $<span id="checkout-sidebar-items-ship-hand">0.00</span>\n              </div>\n            </li>\n            <li class="checkout-details-row">\n              <div class="checkout-details-cell-one">\n              </div>\n              <div id="checkout-details-divider"\n                   class="checkout-details-cell-two">\n              </div>\n            </li>\n            <li class="checkout-details-row">\n              <div class="checkout-details-cell-one">\n                Total before tax:\n              </div>\n              <div class="checkout-details-cell-two">\n                $<span id="checkout-sidebar-items-subtotal">0.00</span>\n              </div>\n            </li>\n            <li class="checkout-details-row">\n              <div class="checkout-details-cell-one">\n                Estimated tax to be collected:\n              </div>\n              <div class="checkout-details-cell-two">\n                $<span id="checkout-sidebar-items-tax">0.00</span>\n              </div>\n            </li>\n          </ul>\n        </div>\n      </section>\n      <div id="checkout-total-price-table">\n        <div id="checkout-total-price-row">\n          <div id="checkout-total-price-cell-one">\n            Order Total:\n          </div>\n          <div id="checkout-total-price-cell-two">\n            $<span id="checkout-total-price">0.00</span>\n          </div>\n        </div>\n      </div>\n    </div>\n  </section>\n</main>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["checkouts/checkout_placed"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<main id="checkout-placed-view">\n  <section id="checkout-order-placed">\n    Your order has been placed!\n  </section>\n\n  <section id="checkout-placed-redirect">\n    <a class="checkout-placed-link" href="/">\n        Continue Shopping</a>?\n    <a class="checkout-placed-link"\n       href="/session"\n       data-method="delete">\n      Sign out</a>?\n  </section>\n</main>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["checkouts/current_address"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('');  if (!_.isEmpty(address.attributes)) { ; __p.push('\n    <span id="current-address-name">\n      ',  address.escape("name").toUpperCase() ,',\n    </span>\n    <span id="current-address-street">\n      ',  address.escape("street").toUpperCase() ,',\n    </span>\n    ');  if (address.escape("apt")) { ; __p.push('\n      <span id="current-address-apt">\n        APT. ',  address.escape("apt").toUpperCase() ,',\n      </span>\n    ');  } ; __p.push('\n    <span id="current-address-city">\n      ',  address.escape("city").toUpperCase() ,',\n    </span>\n    <span id="current-address-state">\n      ',  address.escape("state").toUpperCase() ,',\n    </span>\n    <span id="current-address-zip">\n      ',  address.escape("zip").toUpperCase() ,'\n    </span>\n');  } else { ; __p.push('\n    <span id="no-address-current-selection">\n      You haven\'t added any shipping addresses yet.\n    </span>\n');  } ; __p.push('\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["checkouts/current_card"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('');  if (card) { ; __p.push('\n    <span id="current-card-brand">\n      ',  card.brand ,'\n    </span>\n    <span id="current-card-last4">\n      ending in\n      <span id="current-card-number">\n        ',  card.last4 ,'\n      </span>\n    </span>\n');  } else { ; __p.push('\n    <span id="no-payment-current-selection">\n      You haven\'t added any credit or debit cards yet.\n    </span>\n');  } ; __p.push('\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["checkouts/must_sign_in"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<main id="sign-in-before-checkout">\n  You must\n  <a href="/session/new" class="sign-in-or-up">\n    sign in</a>\n  or\n  <a href="/users/new" class="sign-in-or-up">\n    sign up</a>\n  before you can checkout.\n</main>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["checkouts/payment_form"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<section id="add-card-form-overlay">\n  <div id="add-card-relative-container">\n    <div id="add-card-modal">\n      <div class="top-bar group">\n        <span class="top-bar-title">\n          Add a debit or credit card (TEST MODE)\n        </span>\n        <span class="top-bar-x">\n          &times\n        </span>\n      </div>\n      <div id="add-card-form-container">\n        <form id="add-card-form" action="checkout/add_card" method="post">\n          <span class="payment-errors"></span>\n\n          <div class="form-row">\n            <div class="first-form-cell">\n              <span>Card number</span>\n            </div>\n            <div class="second-form-cell">\n              <input id="card-number"\n                     type="text"\n                     size="20"\n                     data-stripe="number"\n                     autofocus="autofocus"/>\n\n              <span>CVC</span>\n              <input type="text" size="4" data-stripe="cvc"/>\n            </div>\n          </div>\n\n          <div class="form-row">\n            <div class="first-form-cell">\n              <span>Name on card</span>\n            </div>\n            <div class="second-form-cell">\n              <input type="text" size="30" data-stripe="name"/>\n            </div>\n          </div>\n\n          <div class="form-row">\n            <div class="first-form-cell">\n              <span>Expiration date (MM/YYYY)</span>\n            </div>\n            <div class="second-form-cell">\n              <input type="text" size="2" data-stripe="exp-month"/>\n              <span> / </span>\n              <input type="text" size="4" data-stripe="exp-year"/>\n            </div>\n          </div>\n\n          <div class="form-row">\n            <span class="first-form-cell"></span>\n            <div class="second-form-cell">\n              <input type="checkbox" name="set_as_default" value="true">\n              Use as my default payment\n            </div>\n          </div>\n\n          <div id="add-card-form-button-container">\n            <button>Add your card</button>\n          </div>\n        </form>\n      </div>\n    </div>\n  </div>\n</section>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["checkouts/payment_methods"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<form id="payment-method-form" action="/checkout/select_card" method="post">\n  <div id="payment-method-form-header-table">\n    <ul>\n      <li id="payment-method-form-header-title-cell">\n        <span id="payment-method-header-title">\n          Your credit and debit cards\n        </span>\n      </li>\n      <li id="payment-method-form-header-name-cell">\n        <span id="payment-method-header-name">\n          Name on card\n        </span>\n      </li>\n      <li id="payment-method-form-header-expire-cell">\n        <span id="payment-method-header-expire">\n          Expires on\n        </span>\n      </li>\n    </ul>\n  </div>\n  ');  if (cards.length < 1) { ; __p.push('\n        <span id="no-card-selection">\n          You don\'t have any saved credit or debit cards.\n        </span>\n      </form>\n      <div id="payment-add-first-card">\n        Add a credit or debit card?\n      </div>\n  ');  } else { ; __p.push('\n      ');  cards.each( function(card){ ; __p.push('\n        <ul>\n          <li class="card-table">\n            <ul>\n              <li class="first-card-cell">\n                <span class="card-radio">\n                  <input type="radio"\n                         name="cardId"\n                         value="',  card.escape("id") ,'">\n                </span>\n                <span class="card-brand">\n                  ',  card.escape("brand") ,'\n                </span>\n                <span class="card-last4">\n                  ending in\n                  <span class="card-number">\n                    ',  card.escape("last4") ,'\n                  </span>\n                </span>\n              </li>\n              <li class="second-card-cell">\n                <span class="card-name">\n                  ',  card.escape("name") ,'\n                </span>\n              </li>\n              <li class="third-card-cell">\n                <span class="card-exp">\n                  ');  if (card.escape("exp_month").length === 1) { ; __p.push('\n                      ');  var exp_month = "0" + card.escape("exp_month") ; __p.push('\n                  ');  } else { ; __p.push('\n                      ');  var exp_month = card.escape("exp_month") ; __p.push('\n                  ');  } ; __p.push('\n                  ',  exp_month ,'/',  card.escape("exp_year") ,'\n                </span>\n              </li>\n            </ul>\n          </li>\n        </ul>\n      ');  }) ; __p.push('\n      <div id="payment-method-form-button-table">\n        <ul>\n          <li id="payment-method-button-cell">\n            <button id="payment-method-form-button">\n              Use this payment method\n            </button>\n          </li>\n          <li id="payment-add-card-cell">\n            <div id="payment-add-card">\n              Add another card?\n            </div>\n          </li>\n        </ul>\n      </div>\n  ');  }; ; __p.push('\n</form>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["checkouts/shipping_addresses"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<form id="shipping-address-form" action="/checkout/select_address" method="post">\n  <div id="shipping-address-form-header-table">\n    <div id="shipping-address-form-header-title-cell">\n      <span id="shipping-address-header-title">\n        Your addresses\n      </span>\n    </div>\n  </div>\n  ');  if (addresses.length < 1) { ; __p.push('\n        <span id="no-address-selection">\n          You don\'t have any saved shipping addresses.\n        </span>\n      </form>\n      <div id="shipping-add-first-address">\n        Add a shipping address?\n      </div>\n  ');  } else { ; __p.push('\n      ');  addresses.each( function (address) { ; __p.push('\n        <ul>\n          <li class="address-table">\n            <ul>\n              <li class="address-radio-cell">\n                <span class="address-radio">\n                  <input type="radio"\n                         name="addressId"\n                         value="',  address.escape("id") ,'">\n                </span>\n              </li>\n              <li class="address-info-cell">\n                <div class="address-info-container">\n                  <span class="address-name">\n                    ',  address.escape("name").toUpperCase() ,',\n                  </span>\n                  <span class="address-street">\n                    ',  address.escape("street").toUpperCase() ,',\n                  </span>\n                  ');  if (address.escape("apt")) { ; __p.push('\n                    <span class="address-apt">\n                      ',  address.escape("apt").toUpperCase() ,',\n                    </span>\n                  ');  } ; __p.push('\n                  <span class="address-city">\n                    ',  address.escape("city").toUpperCase() ,',\n                  </span>\n                  <span class="address-state">\n                    ',  address.escape("state").toUpperCase() ,',\n                  </span>\n                  <span class="address-zip">\n                    ',  address.escape("zip").toUpperCase() ,'\n                  </span>\n                </div>\n              </li>\n            </ul>\n          </li>\n        </ul>\n      ');  }) ; __p.push('\n      <div id="shipping-address-form-button-table">\n        <ul>\n          <li id="shipping-address-button-cell">\n            <button id="shipping-address-form-button">\n              Use this shipping address\n            </button>\n          </li>\n          <li id="add-another-address-cell">\n            <div id="add-another-address">\n              Add another address?\n            </div>\n          </li>\n        </ul>\n      </div>\n    </form>\n');  } ; __p.push('\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["current_users/cart"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<main id="cart-show">\n  ');  if (products.length < 1) { ; __p.push('\n    <section id="empty-cart">\n      <header id="empty-cart-header">\n        Your Shopping Cart is empty.\n      </header>\n      <body>\n        <ul id="empty-cart-ul">\n          <li class="empty-cart-li">\n            Your Shopping Cart lives to serve.\n            Give it purpose — fill it with books, CDs, DVDs, toys, electronics, and more.\n            If you already have an account,\n              <a href="/session/new">Sign In</a>\n            to see your Cart.\n          </li>\n          <li class="empty-cart-li">\n            Continue shopping on the\n              <a href="/">Hippolyta.us</a>\n            homepage.\n          </li>\n          <li class="empty-cart-li">\n            The price and availability of items at Hippolyta.us are subject to change.\n            The Cart is a temporary place to store a list of your items and reflects\n            each item\'s most recent price.\n          </li>\n        </ul>\n      </body>\n    </section>\n  ');  } else { ; __p.push('\n    <section id="populated-cart">\n      <div id="main">\n        <ul>\n          <li>\n            <header>Your Shopping Cart</header>\n          </li>\n        </ul>\n\n        <ul id="column-labels">\n          <li id="cart-spacer"></li>\n          <li id="price-label">\n            Price\n          </li>\n          <li id="quantity-label">\n            Quantity\n          </li>\n        </ul>\n\n        ');  var cart_subtotal_price = 0; ; __p.push('\n        ');  var cart_total_quantity = 0; ; __p.push('\n        ');  products.each( function(product) { ; __p.push('\n          ');  var cartProduct = cartProducts.getOrFetchByCartAndProductId(cart.id, product.id); ; __p.push('\n          ');  var salePrice = (product.escape("sale_price") * 1).toFixed(2); ; __p.push('\n          ');  var subtotal = (cartProduct.escape("quantity") * salePrice).toFixed(2); ; __p.push('\n          ');  if (product.escape("original_price")) { ; __p.push('\n            ');  var originalPrice = (product.escape("original_price") * 1).toFixed(2); ; __p.push('\n            ');  var amountSavedPer = (originalPrice - salePrice).toFixed(2); ; __p.push('\n            ');  var amountSavedTotal = (amountSavedPer * cartProduct.escape("quantity")).toFixed(2); ; __p.push('\n            ');  var percentSaved = (100 / (subtotal / amountSavedTotal)).toFixed(0) ; __p.push('\n          ');  }; ; __p.push('\n          <div class="product">\n            <ul class="image-cell">\n              <li>\n                <a href=\'#sellers/',  product.escape("seller_id") ,'/products/',  product.id ,'\'>\n                  <img src="',  product.escape("small_picture_url") ,'" alt="product image"/>\n                </a>\n              </li>\n            </ul>\n\n            <ul class="name-cell">\n              <li class="name-li">\n                <a href=\'#sellers/',  product.escape("seller_id") ,'/products/',  product.id ,'\'>\n                    ',  product.escape("name") ,'\n                </a>\n              </li>\n\n              <li class="sold-by">\n                sold by ',  product.escape("seller_name") ,'\n              </li>\n\n              ');  var quantity = product.escape("quantity") ; __p.push('\n              ');  if (quantity < 1) { ; __p.push('\n                  <li class="out-of-stock">\n                    Out of Stock\n                  </li>\n              ');  } else if (quantity > 25) { ; __p.push('\n                  <li class="in-stock">\n                    In Stock\n                  </li>\n              ');  } else { ; __p.push('\n                  <li class="left-in-stock">\n                    Only ',  quantity ,' left in stock.\n                  </li>\n              ');  }; ; __p.push('\n\n              <li class="delete">\n                <a href="/api/cart_products/del/',  product.id ,'" data-method="delete">\n                  Delete from Cart\n                </a>\n              </li>\n            </ul>\n\n            <ul class="price-cell">\n              <li class="price-total">\n                $',  subtotal ,'\n              </li>\n\n              ');  if (amountSavedTotal) { ; __p.push('\n                <li class="saved-total">\n                  You save:\n                  <div>\n                    $',  amountSavedTotal ,'\n                    ');  if (amountSavedTotal > 0) { ; __p.push('\n                        (',  percentSaved ,'%)\n                    ');  } else { ; __p.push('\n                        (0%)\n                    ');  }; ; __p.push('\n                  </div>\n                </li>\n              ');  }; ; __p.push('\n            </ul>\n\n            <ul class="quantity-cell">\n              <li>\n                <form action="/api/cart_products/qty/',  product.id ,'" method="post">\n                  <input type="hidden" name="_method" value="patch">\n                    <input type="number"\n                           min="0"\n                           max="',  product.escape("quantity") ,'"\n                           name="cart_product[quantity]"\n                           value="',  cartProduct.escape("quantity") ,'">\n                    <br>\n                    <button>Update</button>\n                </form>\n              </li>\n            </ul>\n          </div>\n\n          ');  cart_subtotal_price += Number(subtotal); ; __p.push('\n          ');  cart_total_quantity += Number(cartProduct.escape("quantity")) ; __p.push('\n        ');  }) ; __p.push('\n      </div>\n\n      <div id="side-bar">\n        <div id="checkout-box">\n          <ul>\n            <li id="subtotal">\n              Subtotal (',  cart_total_quantity ,' items):\n              <span id="subtotal-span">$',  cart_subtotal_price.toFixed(2) ,'</span>\n            </li>\n\n            <li id="checkout-button">\n              <a href="/checkout#checkout">\n                Proceed to checkout\n              </a>\n            </li>\n          </ul>\n        </div>\n      </div>\n    </section>\n  ');  }; ; __p.push('\n</main>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["current_users/products"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<main>\n  ');  if (products.length < 1) { ; __p.push('\n    You\'re not selling any products yet. Would you like to <a href="#products/new">sell something?</a>\n  ');  }; ; __p.push('\n  <ul>\n    ');  products.each( function (product) { ; __p.push('\n      <li>\n        <ul>\n          <li>\n            <img src="',  product.escape("medium_picture_url") ,'" alt="product image"/>\n          </li>\n          <li>\n            Name: ',  product.escape("name") ,'\n          </li>\n          <li>\n            Sale price: $',  product.escape("sale_price") ,'\n          </li>\n          <li>\n            ');  if (product.escape("original_price")) { ; __p.push('\n              Original Price: $',  product.escape("original_price") ,'\n            ');  } ; __p.push('\n          </li>\n          <li>\n            Quantity: ',  product.escape("quantity") ,'\n          </li>\n          <li>\n            ');  if (product.escape("description")) { ; __p.push('\n              Description: ',  product.escape("description") ,'\n            ');  } ; __p.push('\n          </li>\n          <button>Edit Product</button>\n        </ul>\n      </li>\n    ');  }) ; __p.push('\n  </ul>\n\n  <div id="name">\n    <a href="#products/new">Add a product</a>\n  </div>\n</main>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["current_users/profile"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<section id="user-private-profile">\n  ');  if (!currentUser.escape("email") || !currentUser.escape("name")) { ; __p.push('\n      <div id="sign-in-to-view-profile">\n        <a href="/session/new" class="sign-in-or-up">\n          Sign in</a>\n        or\n        <a href="/users/new" class="sign-in-or-up">\n          sign up</a>\n        to view and edit your profile.\n      </div>\n  ');  } else { ; __p.push('\n      <img id="user-image"\n           src="',  currentUser.escape("small_picture_url") ,'"\n           alt="',  currentUser.escape("name") ,'\'s picture/logo"/>\n\n      ',  currentUser.escape("name") ,'\'s Hippolyta\n\n      Customer since ',  new Date(currentUser.escape("created_at")) ,'\n\n      <a href="#current_user/products">My Products</a>\n  ');  } ; __p.push('\n</section>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["products/new"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<main id="current-user-product-new">\n  <form id="product-new-form" action="" method="post">\n    <ul>\n      <li id="product-new-form-errors" class="product-new-form-row">\n        <div id="product-new-form-error-message">\n          There was an error while saving your product.\n          Please check to make sure that your form information is complete,\n          and then try again.\n        </div>\n      </li>\n      <li class="product-new-form-row">\n        <div>My Product\'s Name</div>\n        <div>(used when conducting searches to find your product)</div>\n        <input type="text" name="name" value="">\n      </li>\n      <li class="product-new-form-row">\n        <div>My Product\'s Sale Price</div>\n        <div>\n          (amount that you intend to sell your product for in USD)\n        </div>\n        <input type="text" name="sale_price" value="">\n      </li>\n      <li class="product-new-form-row">\n        <div>My Product\'s Original Price (optional)</div>\n        <div>\n          (used to calculate how much your customers are saving\n          by buying your product at Sale Price)\n        </div>\n        <input type="text" name="original_price" value="">\n      </li>\n      <li class="product-new-form-row">\n        <div>Quantity of Stock of My Product</div>\n        <div>(enter a number)</div>\n        <input type="number" name="quantity" value="">\n      </li>\n      <li class="product-new-form-row">\n        <div>Description of My Product (optional)</div>\n        <div>(used when conducting searches to find your product)</div>\n        <input type="text" name="description" value="">\n      </li>\n      <li class="product-new-form-row">\n        <div>Tags Associated with My Product (optional)</div>\n        <div>(used when conducting searches to find your product)</div>\n        <input type="text" name="tags" value="">\n      </li>\n      <li class="product-new-form-row">\n        <div>Image for My Product</div>\n        <input id="input-picture-file" type="file" name="picture">\n      </li>\n      <li class="product-new-form-row">\n        <img src="" id="picture-new-preview"/>\n      </li>\n    </ul>\n\n    <button id="product-new-form-button">\n      Add My Product to Hippolyta.us!\n    </button>\n  </form>\n</main>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["products/show"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<main id="product-show" class="group">\n\n  ');  if (product.escape("last_query")) { ; __p.push('\n    <header>\n      <a href="/#search_results">\n        <div id="back-arrow">\n        </div>Back\n        to search results for\n        "<span>',  product.escape("last_query") ,'</span>"\n      </a>\n    </header>\n  ');  }; ; __p.push('\n\n  <div id="product">\n    <ul id="picture-cell">\n      <li id="picture">\n        <img src="',  product.escape("large_picture_url") ,'" alt="product image"/>\n      </li>\n    </ul>\n\n    <ul id="info-cell">\n      <li id="name">\n        ',  product.escape("name") ,'\n      </li>\n\n      <li id="price-tables">\n        ');  var salePrice = (product.escape("sale_price") * 1).toFixed(2) ; __p.push('\n        ');  if (product.escape("original_price")) { ; __p.push('\n            ');  var originalPrice = (product.escape("original_price") * 1).toFixed(2) ; __p.push('\n            ');  var amountSaved = (originalPrice - salePrice).toFixed(2) ; __p.push('\n            ');  var percentSaved = (100 / (salePrice / amountSaved)).toFixed(0) ; __p.push('\n            <ul class="prices">\n              <li class="price-type">\n                List Price:\n              </li>\n\n              <li id="original-price">\n                $',  originalPrice ,'\n              </li>\n            </ul>\n\n            <ul id="price" class="prices">\n              <li class="price-type">\n                Price:\n              </li>\n\n              <li id="sale-price" class="red-prices">\n                $',  salePrice ,'\n              </li>\n            </ul>\n\n            <ul class="prices">\n              <li class="price-type">\n                You save:\n              </li>\n\n              <li class="red-prices">\n                $',  amountSaved ,'\n                (',  percentSaved ,'%)\n              </li>\n            </ul>\n        ');  } else { ; __p.push('\n            <ul id="price" class="prices">\n              <li class="price-type-sale-only">\n                Price:\n              </li>\n\n              <li id="sale-price" class="red-prices">\n                $',  salePrice ,'\n              </li>\n            </ul>\n        ');  }; ; __p.push('\n      </li>\n\n\n      ');  var quantity = product.escape("quantity") ; __p.push('\n      ');  if (quantity < 1) { ; __p.push('\n          <li id="out-of-stock">\n            Out of Stock\n          </li>\n      ');  } else if (quantity > 25) { ; __p.push('\n          <li id="in-stock">\n            In Stock\n          </li>\n      ');  } else { ; __p.push('\n          <li id="left-in-stock">\n            ',  quantity ,' left in stock.\n          </li>\n      ');  }; ; __p.push('\n\n      <li id="seller-name">\n        Sold by ',  product.escape("seller_name") ,'\n      </li>\n    </ul>\n\n    <ul id="add-to-cart-cell">\n      <li>\n        <form id="add-to-cart-form"\n              action="/api/cart_products/add/',  product.id ,'"\n              method="post">\n\n          Qty: <input type="number"\n                 min="0"\n                 max="',  product.escape("quantity") ,'"\n                 name="cart_product[quantity]"\n                 value="1">\n          <br>\n          <button id="add-to-cart-button">\n            <div id="add-to-cart-image">\n              <img id="cart-image"\n                   src="/assets/cart-button.png"\n                   alt="cart-image" />\n            </div>\n            <div id="add-to-cart-text">\n              Add to Cart\n            </div>\n          </button>\n        </form>\n      </li>\n    </ul>\n  </div>\n\n  <div id="description">\n    <ul>\n      ');  if (product.escape("description")) { ; __p.push('\n          <li>\n            <div id="description-title">\n              Product Description:\n            </div>\n\n            <span id="description-text">\n              ',  product.escape("description") ,'\n            </span>\n          </li>\n      ');  } else { ; __p.push('\n          <li>\n            <div id="description-title">\n              Product Description:\n            </div>\n\n            <span id="description-text">\n              No specific description was given by the seller.\n            </span>\n          </li>\n      ');  }; ; __p.push('\n    </ul>\n  </div>\n</main>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["queries/index"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<main id="search-results">\n  ');  if (results.length < 1) { ; __p.push('\n      <section id="matchless-search">\n        Your search for\n          "<span id="search-query">',  results.keywords ,'</span>"\n        did not match any products.\n      </section>\n  ');  } else { ; __p.push('\n      <section id="successful-search">\n        <header>\n          Showing results for:\n            "<span id="search-query">',  results.keywords ,'</span>"\n        </header>\n        <ul id="results">\n          ');  results.each( function(result) { ; __p.push('\n            ');  var quantity = result.escape("quantity") ; __p.push('\n            ');  var salePrice = (result.escape("sale_price") * 1).toFixed(2) ; __p.push('\n            ');  if (result.escape("original_price")) { ; __p.push('\n              ');  var originalPrice = (result.escape("original_price") * 1).toFixed(2); ; __p.push('\n            ');  }; ; __p.push('\n            <li>\n              <ul class="result">\n                <li class="image-cell">\n                  <ul>\n                    <li class="image">\n                      <a href=\'#sellers/',  result.escape("seller_id") ,'/products/',  result.id ,'\'>\n                        <img src="',  result.escape("medium_picture_url") ,'" alt="product image"/>\n                      </a>\n                    </li>\n                  </ul>\n                </li>\n\n                <li class="info-cell">\n                  <ul class="info-ul">\n                    <li class="name">\n                      <a href=\'#sellers/',  result.escape("seller_id") ,'/products/',  result.id ,'\'>\n                        ',  result.escape("name") ,'\n                      </a>\n                    </li>\n\n                    <li class="sold-by">\n                        Sold by ',  result.escape("seller_name") ,'\n                    </li>\n\n                    <li class="sale-price">\n                      <a href=\'#sellers/',  result.escape("seller_id") ,'/products/',  result.id ,'\'>\n                        $',  salePrice ,'\n                      </a>\n\n                      ');  if (originalPrice) { ; __p.push('\n                        <span class="original-price">\n                          $',  originalPrice ,'\n                        </span>\n                      ');  }; ; __p.push('\n                    </li>\n\n                    ');  if (quantity < 1) { ; __p.push('\n                        <li class="out-of-stock stock">\n                          <a href=\'#sellers/',  result.escape("seller_id") ,'/products/',  result.id ,'\'>\n                            Out of Stock\n                          </a>\n                        </li>\n                    ');  } else if (quantity > 25) { ; __p.push('\n                        <li class="in-stock stock">\n                          <a href=\'#sellers/',  result.escape("seller_id") ,'/products/',  result.id ,'\'>\n                            In Stock\n                          </a>\n                        </li>\n                    ');  } else { ; __p.push('\n                        <li class="left-in-stock stock">\n                          <a href=\'#sellers/',  result.escape("seller_id") ,'/products/',  result.id ,'\'>\n                            ',  quantity ,' left in stock\n                          </a>\n                        </li>\n                    ');  }; ; __p.push('\n                  </ul>\n                </li>\n              </ul>\n            </li>\n          ');  }) ; __p.push('\n        </ul>\n      </section>\n  ');  }; ; __p.push('\n</main>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["users/edit"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<img id="profile-pic"\n     style="max-width: 300px; max-height: auto;"\n     src="',  user.escape("large_picture_url") ,'"\n     alt="my current profile picture / logo" />\n\n<br>\n\n<form id="upload-form">\n  <input id="upload-button" type="file" name="picture">\n\n  <p id="reset-picture" style="cursor: pointer; display: block; width: 150px;">\n    Reset preview to current picture\n  </p>\n\n  <button>Upload</button>\n</form>\n\n<br>\n<br>\n\n<strong style="padding-right: 50px;">',  user.escape("name") ,'</strong>\n<button>Edit</button>\n');}return __p.join('');};
}).call(this);
Hippolyta.Models.CartProduct = Backbone.Model.extend({
  urlRoot: "api/cart_products",
});

Hippolyta.Models.cartProduct = new Hippolyta.Models.CartProduct();
...
Hippolyta.Models.CurrentUserCurrentAddress = Backbone.Model.extend({
  urlRoot: "/api/current_user/current_address",
});

Hippolyta.Models.currentUserCurrentAddress = new Hippolyta.Models.CurrentUserCurrentAddress();
